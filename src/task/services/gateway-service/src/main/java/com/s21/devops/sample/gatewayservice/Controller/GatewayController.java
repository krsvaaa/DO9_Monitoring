...
public class GatewayController {
    ...
    public void bookHotel(@Valid @RequestBody BookHotelReq bookHotelReq,
                          @RequestHeader("Authorization") String authorization)
            throws CustomJwtException, ReservationAlreadyExistsException,
            CustomRuntimeException, HotelAlreadyExistsException {
    ...
    public HotelsAavailabilityRes getBookingAvailability(@PathVariable UUID hotelUid,
    ...
    public void patchRoomsInfo(@PathVariable UUID hotelUid,
    ...
    public BookingStatisticsMessage[] getBookingStats(@RequestParam("from") String from,
    ...
    public HotelFillingStatistics[] getFillingStats(@RequestParam("from") String from,
                                                    @RequestParam("to") String to)
            throws CustomJwtException, CustomRuntimeException {
        metricsCollector.incrementRequestReceived();
    ...
    private UUID getUserUid(String authorization)
            throws CustomJwtException, CustomRuntimeException {
